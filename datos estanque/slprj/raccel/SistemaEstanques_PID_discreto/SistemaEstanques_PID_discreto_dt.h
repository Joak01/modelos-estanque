...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . m2w3hx33rl
) , 0 , 0 , 25 } , { ( char_T * ) ( & rtDW . f1gmat2bv1 ) , 0 , 0 , 2 } , { (
char_T * ) ( & rtDW . aexhwn1xad . LoggedData ) , 11 , 0 , 15 } , { ( char_T
* ) ( & rtDW . hxixz0diaj ) , 7 , 0 , 18 } , { ( char_T * ) ( & rtDW .
cijhhdchyo ) , 8 , 0 , 18 } } ; static DataTypeTransitionTable rtBTransTable
= { 5U , rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = {
{ ( char_T * ) ( & rtP . PIDController_D ) , 0 , 0 , 69 } } ; static
